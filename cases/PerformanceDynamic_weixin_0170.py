...
class PerformanceDynamic_weixin_0170(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(self.TEST_TIME):
            ...
            try:
                ...
                time.sleep(2)
                self._log_step('3、点击京东购物小程序')
                self._click('京东购物', 0.85, 0.20, contains=True, wait=5)
                self._log_step('4、浏览京东购物首页，上滑3次、下滑3次')
                self._browse(3)
                self._log_step('5、返回微信主界面')
