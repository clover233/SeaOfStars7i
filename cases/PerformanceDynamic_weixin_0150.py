...
class PerformanceDynamic_weixin_0150(WeixinCase):
    """Excel 7.0.2：美团小程序首页浏览。"""
    ...
    def run_case(self):
        for iteration in range(self.TEST_TIME):
            ...
            self.step(3, '点击美团小程序，切换到美团页面')
            self.open_common_mini_program(self.MEITUAN_MINI, '美团')
            self.step(4, '浏览美团首页，上滑3次，下滑3次')
            self.browse(3, 3)
            self.step(5, '返回微信主界面')
